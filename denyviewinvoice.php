            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Accept Invoice</h4>
 ...
 <div class="row">
               ...
               <input type="text" name="cashier" value="<?php echo $_GET['cashier']; ?>" readonly class="form-input" aria-required="true" />
                                         ...
                                         <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                <div class="form-group">
               <input type="text" name="name" value="Rejected"  readonly class="form-input" aria-required="true" />
                                                </div>
                                            </div>
                                        </div>
                                         <div class="row">
...
<input type="hidden" name="name" value="<?php echo $_GET['cname']; ?>" />
...
<input type="hidden" name="pstatus" value="pending" />
                                    ...
                                    <div class="form-actions">
                                        <div class="text-right">
                                            <button type="submit"  name="submit" class="btn btn-info">Deny Payment</button>
